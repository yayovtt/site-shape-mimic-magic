...
>(({ className, ...props }, ref) => (
  <div className="relative w-full h-96 overflow-auto border rounded-lg">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-16 px-6 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0 text-lg",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-6 align-middle [&:has([role=checkbox])]:pr-0 text-lg", className)}
    {...props}
  />
))
